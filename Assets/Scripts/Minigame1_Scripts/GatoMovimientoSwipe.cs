...
public class GatoMovimientoSwipe : MonoBehaviour
{
    ...
    private void DetectarToque()
    {
        ...
        {
            rb.velocity = Vector2.zero; // Detener el movimiento cuando no se toca la pantalla
        }
    }

    private void ActualizarAnimacion()
    {
        animator.SetBool("isWalking", rb.velocity.x != 0); // Activar animación del gato andando si se mueve de lado a lado
    }

    // Para evitar que el gato salga de la pantalla
