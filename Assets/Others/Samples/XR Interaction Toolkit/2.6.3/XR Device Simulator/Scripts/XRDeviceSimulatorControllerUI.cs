...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.DeviceSimulator
{
    ...
    internal class XRDeviceSimulatorControllerUI : MonoBehaviour
    {
        ...
        [SerializeField]
        private Image m_ControllerImage;

        [SerializeField]
        private Image m_ControllerOverlayImage;
        ...
        [SerializeField]
        private Text m_PrimaryButtonText;

        [SerializeField]
        private Image m_PrimaryButtonIcon;
        ...
        [SerializeField]
        private Text m_SecondaryButtonText;

        [SerializeField]
        private Image m_SecondaryButtonIcon;

        [Header("Trigger")]

        [SerializeField]
        private Image m_TriggerButtonImage;

        [SerializeField]
        private Text m_TriggerButtonText;

        [SerializeField]
        private Image m_TriggerButtonIcon;

        [Header("Grip")]

        [SerializeField]
        private Image m_GripButtonImage;

        [SerializeField]
        private Text m_GripButtonText;

        [SerializeField]
        private Image m_GripButtonIcon;
        ...
        [SerializeField]
        private Text m_ThumbstickButtonText;

        [SerializeField]
        private Image m_ThumbstickButtonIcon;

        [Header("Menu")]

        [SerializeField]
        private Image m_MenuButtonImage;

        [SerializeField]
        private Text m_MenuButtonText;

        [SerializeField]
        private Image m_MenuButtonIcon;
